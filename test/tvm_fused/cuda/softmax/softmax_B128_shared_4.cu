...
#endif
extern "C" __global__ void __launch_bounds__(64) softmax_shared_4(float* __restrict__ T_softmax_norm, float* __restrict__ data) {
...
extern "C" __global__ void __launch_bounds__(64) softmax_shared_4_copy(float* __restrict__ T_softmax_norm, float* __restrict__ data) {
  float normal_reduce_temp0[1];
  __shared__ float red_result[1];
  __shared__ float T_softmax_maxelem[1];
  float normal_reduce_temp0_1[1];
