...
#endif
extern "C" __global__ void __launch_bounds__(112) default_function_kernel(float* __restrict__ DepthwiseConv2d, float* __restrict__ data, float* __restrict__ kernel) {
