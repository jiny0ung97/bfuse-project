static int kernel1_I_shape_0[] = {16, 512, 64, 1};
static int kernel1_F_shape_0[] = {16, 512, 64, 1};
static int kernel1_O_shape_0[] = {16, 512, 512, 1};
//------------------------------------------------------------------------------------------
static int kernel2_I_shape_0[] = {1, 64, 112, 112};
static int kernel2_F_shape_0[] = {192, 64, 3, 3};
static int kernel2_O_shape_0[] = {1, 192, 55, 55};
//------------------------------------------------------------------------------------------
static unsigned int kernel1_gridDim_0[] = {8, 8, 16};
static unsigned int kernel1_blockDim_0[] = {8, 8, 1};
//------------------------------------------------------------------------------------------
static unsigned int kernel2_gridDim_0[] = {55, 11, 3};
static unsigned int kernel2_blockDim_0[] = {1, 1, 16};
//------------------------------------------------------------------------------------------
static unsigned int hfuse_gridDim_0[] = {1815, 1, 1};
static unsigned int hfuse_blockDim_0[] = {96, 1, 1};
//------------------------------------------------------------------------------------------
static unsigned int bfuse_gridDim_0[] = {2839, 1, 1};
