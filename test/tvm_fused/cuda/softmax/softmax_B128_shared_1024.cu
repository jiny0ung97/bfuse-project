...
#endif
extern "C" __global__ void __launch_bounds__(64) softmax_shared_1024(float* __restrict__ T_softmax_norm, float* __restrict__ data) {
  float normal_reduce_temp0[1];
  __shared__ float red_result[256]; //
  __shared__ float T_softmax_maxelem[256]; //
  float normal_reduce_temp0_1[1];
  __shared__ float red_result_1[256]; //
  __shared__ float T_softmax_expsum[256]; //
...
extern "C" __global__ void __launch_bounds__(64) softmax_shared_1024_copy(float* __restrict__ T_softmax_norm, float* __restrict__ data) {
  float normal_reduce_temp0[1];
  __shared__ float red_result[256]; //
  __shared__ float T_softmax_maxelem[256]; //
  float normal_reduce_temp0_1[1];
