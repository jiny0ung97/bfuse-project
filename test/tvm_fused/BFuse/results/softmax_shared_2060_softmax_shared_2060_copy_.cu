...
extern "C" __global__ __launch_bounds__(128) void softmax_shared_2060_softmax_shared_2060_copy_fused_kernel_bfuse_idx_0(float *__restrict softmax_shared_2060_T_softmax_norm_, float *__restrict softmax_shared_2060_data_, float *__restrict softmax_shared_2060_copy_T_softmax_norm_, float *__restrict softmax_shared_2060_copy_data_)
{
  /*
   * KernelID_ means...
   * 0: softmax_shared_2060
   * 1: softmax_shared_2060_copy
   */
  ...
  static float union_shared_0_[513] __attribute__((shared));
  static float union_shared_1_[513] __attribute__((shared));
  static float union_shared_2_[513] __attribute__((shared));
  static float union_shared_3_[513] __attribute__((shared));
  ...
  if ((KernelID_ == 0) && ((threadIdx.x + threadIdx.y * blockDim.x + threadIdx.z * blockDim.x * blockDim.y >= 0 && threadIdx.x + threadIdx.y * blockDim.x + threadIdx.z * blockDim.x * blockDim.y < 128)))
  {
      ...
      normal_reduce_temp0[0] = max(normal_reduce_temp0[0], softmax_shared_2060_data_[((((int)blockIdx_x_) * 1000) + ((int)threadIdx.x))]);
      normal_reduce_temp0[0] = max(normal_reduce_temp0[0], softmax_shared_2060_data_[(((((int)blockIdx_x_) * 1000) + ((int)threadIdx.x)) + 128)]);
      normal_reduce_temp0[0] = max(normal_reduce_temp0[0], softmax_shared_2060_data_[(((((int)blockIdx_x_) * 1000) + ((int)threadIdx.x)) + 256)]);
      normal_reduce_temp0[0] = max(normal_reduce_temp0[0], softmax_shared_2060_data_[(((((int)blockIdx_x_) * 1000) + ((int)threadIdx.x)) + 384)]);
      normal_reduce_temp0[0] = max(normal_reduce_temp0[0], softmax_shared_2060_data_[(((((int)blockIdx_x_) * 1000) + ((int)threadIdx.x)) + 512)]);
      normal_reduce_temp0[0] = max(normal_reduce_temp0[0], softmax_shared_2060_data_[(((((int)blockIdx_x_) * 1000) + ((int)threadIdx.x)) + 640)]);
      normal_reduce_temp0[0] = max(normal_reduce_temp0[0], softmax_shared_2060_data_[(((((int)blockIdx_x_) * 1000) + ((int)threadIdx.x)) + 768)]);
      if (((int)threadIdx.x) < 104) {
          normal_reduce_temp0[0] = max(normal_reduce_temp0[0], softmax_shared_2060_data_[(((((int)blockIdx_x_) * 1000) + ((int)threadIdx.x)) + 896)]);
      }
      float red_buf0[1];
      unsigned int mask[1];
      float t0[1];
      ...
      for (int k_outer = 0; k_outer < 8; ++k_outer) {
          if (((k_outer * 16) + (((int)threadIdx.x) >> 3)) < 125) {
              normal_reduce_temp0_1[0] = (normal_reduce_temp0_1[0] + __expf((softmax_shared_2060_data_[(((((int)blockIdx_x_) * 1000) + (k_outer * 128)) + ((int)threadIdx.x))] - union_shared_1_[0])));
          }
      }
      float red_buf0_2[1];
      ...
      for (int i2_outer = 0; i2_outer < 8; ++i2_outer) {
          if (((i2_outer * 16) + (((int)threadIdx.x) >> 3)) < 125) {
              softmax_shared_2060_T_softmax_norm_[(((((int)blockIdx_x_) * 1000) + (i2_outer * 128)) + ((int)threadIdx.x))] = (__expf((softmax_shared_2060_data_[(((((int)blockIdx_x_) * 1000) + (i2_outer * 128)) + ((int)threadIdx.x))] - union_shared_1_[0])) / union_shared_3_[0]);
          }
      }
  }
  // softmax_shared_2060_copy
  else if ((KernelID_ == 1) && ((threadIdx.x + threadIdx.y * blockDim.x + threadIdx.z * blockDim.x * blockDim.y >= 0 && threadIdx.x + threadIdx.y * blockDim.x + threadIdx.z * blockDim.x * blockDim.y < 128)))
  {
      ...
      float normal_reduce_temp0_1[1];
      normal_reduce_temp0[0] = -3.40282306E+38F;
      normal_reduce_temp0[0] = max(normal_reduce_temp0[0], softmax_shared_2060_copy_data_[((((int)blockIdx_x_) * 1000) + ((int)threadIdx.x))]);
      normal_reduce_temp0[0] = max(normal_reduce_temp0[0], softmax_shared_2060_copy_data_[(((((int)blockIdx_x_) * 1000) + ((int)threadIdx.x)) + 128)]);
      normal_reduce_temp0[0] = max(normal_reduce_temp0[0], softmax_shared_2060_copy_data_[(((((int)blockIdx_x_) * 1000) + ((int)threadIdx.x)) + 256)]);
      normal_reduce_temp0[0] = max(normal_reduce_temp0[0], softmax_shared_2060_copy_data_[(((((int)blockIdx_x_) * 1000) + ((int)threadIdx.x)) + 384)]);
      normal_reduce_temp0[0] = max(normal_reduce_temp0[0], softmax_shared_2060_copy_data_[(((((int)blockIdx_x_) * 1000) + ((int)threadIdx.x)) + 512)]);
      normal_reduce_temp0[0] = max(normal_reduce_temp0[0], softmax_shared_2060_copy_data_[(((((int)blockIdx_x_) * 1000) + ((int)threadIdx.x)) + 640)]);
      normal_reduce_temp0[0] = max(normal_reduce_temp0[0], softmax_shared_2060_copy_data_[(((((int)blockIdx_x_) * 1000) + ((int)threadIdx.x)) + 768)]);
      if (((int)threadIdx.x) < 104) {
          normal_reduce_temp0[0] = max(normal_reduce_temp0[0], softmax_shared_2060_copy_data_[(((((int)blockIdx_x_) * 1000) + ((int)threadIdx.x)) + 896)]);
      }
      float red_buf0[1];
      unsigned int mask[1];
      float t0[1];
      ...
      for (int k_outer = 0; k_outer < 8; ++k_outer) {
          if (((k_outer * 16) + (((int)threadIdx.x) >> 3)) < 125) {
              normal_reduce_temp0_1[0] = (normal_reduce_temp0_1[0] + __expf((softmax_shared_2060_copy_data_[(((((int)blockIdx_x_) * 1000) + (k_outer * 128)) + ((int)threadIdx.x))] - union_shared_1_[0])));
          }
      }
      float red_buf0_2[1];
      unsigned int mask_2[1];
      ...
      for (int i2_outer = 0; i2_outer < 8; ++i2_outer) {
          if (((i2_outer * 16) + (((int)threadIdx.x) >> 3)) < 125) {
              softmax_shared_2060_copy_T_softmax_norm_[(((((int)blockIdx_x_) * 1000) + (i2_outer * 128)) + ((int)threadIdx.x))] = (__expf((softmax_shared_2060_copy_data_[(((((int)blockIdx_x_) * 1000) + (i2_outer * 128)) + ((int)threadIdx.x))] - union_shared_1_[0])) / union_shared_3_[0]);
          }
      }
  }
}
