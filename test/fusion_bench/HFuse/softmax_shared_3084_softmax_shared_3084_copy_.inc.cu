 __global__ __launch_bounds__(128, 8) void softmax_shared_3084_softmax_shared_3084_copy_fused_kernel_vfuse_lb_idx_0(float *__restrict T_softmax_norm0, float *__restrict data1, float *__restrict T_softmax_norm22, float *__restrict data23)
 {
if (((threadIdx.x + threadIdx.y * blockDim.x + threadIdx.z * blockDim.x * blockDim.y)>=0 && (threadIdx.x + threadIdx.y * blockDim.x + threadIdx.z * blockDim.x * blockDim.y) < 128)){
    ...
    static float red_result3[769] __attribute__((shared));
    static float T_softmax_maxelem4[769] __attribute__((shared));
    float normal_reduce_temp0_15[1];
    static float red_result_16[769] __attribute__((shared));
    static float T_softmax_expsum7[769] __attribute__((shared));
...
if (((threadIdx.x + threadIdx.y * blockDim.x + threadIdx.z * blockDim.x * blockDim.y)>=0 && (threadIdx.x + threadIdx.y * blockDim.x + threadIdx.z * blockDim.x * blockDim.y) < 128)){
    ...
    static float red_result25[769] __attribute__((shared));
    static float T_softmax_maxelem26[769] __attribute__((shared));
    float normal_reduce_temp0_127[1];
    static float red_result_128[769] __attribute__((shared));
    static float T_softmax_expsum29[769] __attribute__((shared));
 ...
 __global__ __launch_bounds__(128, 0) void softmax_shared_3084_softmax_shared_3084_copy_fused_kernel_vfuse_idx_0(float *__restrict T_softmax_norm0, float *__restrict data1, float *__restrict T_softmax_norm22, float *__restrict data23)
 {
if (((threadIdx.x + threadIdx.y * blockDim.x + threadIdx.z * blockDim.x * blockDim.y)>=0 && (threadIdx.x + threadIdx.y * blockDim.x + threadIdx.z * blockDim.x * blockDim.y) < 128)){
    unsigned int blockDim_x_0 = 128;
    unsigned int threadIdx_x_0 = ((threadIdx.x + threadIdx.y * blockDim.x + threadIdx.z * blockDim.x * blockDim.y) - 0) % 128;
...
if (((threadIdx.x + threadIdx.y * blockDim.x + threadIdx.z * blockDim.x * blockDim.y)>=0 && (threadIdx.x + threadIdx.y * blockDim.x + threadIdx.z * blockDim.x * blockDim.y) < 128)){
 ...
 __global__ __launch_bounds__(256, 0) void softmax_shared_3084_softmax_shared_3084_copy_fused_kernel_hfuse_idx_0(float *__restrict T_softmax_norm0, float *__restrict data1, float *__restrict T_softmax_norm22, float *__restrict data23)
 {
if (((threadIdx.x + threadIdx.y * blockDim.x + threadIdx.z * blockDim.x * blockDim.y)>=0 && (threadIdx.x + threadIdx.y * blockDim.x + threadIdx.z * blockDim.x * blockDim.y) < 128)){
    unsigned int blockDim_x_0 = 128;
    unsigned int threadIdx_x_0 = ((threadIdx.x + threadIdx.y * blockDim.x + threadIdx.z * blockDim.x * blockDim.y) - 0) % 128;
