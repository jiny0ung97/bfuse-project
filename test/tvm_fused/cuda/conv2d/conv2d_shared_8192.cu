...
extern "C" __global__ void __launch_bounds__(256) conv2d_shared_8192(float* __restrict__ A, float* __restrict__ B, float* __restrict__ W) {
  float B_local[64];
  __shared__ float Apad_shared[4096];//
...
extern "C" __global__ void __launch_bounds__(256) conv2d_shared_8192_copy(float* __restrict__ A, float* __restrict__ B, float* __restrict__ W) {
  float B_local[64];
  __shared__ float Apad_shared[4096];//
  __shared__ float W_shared[4096];//
  float Apad_shared_local[8];
