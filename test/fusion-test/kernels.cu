...
__global__ __launch_bounds__(112) void conv2d_B1_test(float* __restrict__ data, float* __restrict__ kernel, float* __restrict__ conv2d_nhwc) {
...
template <typename TypeA, typename TypeB>
__global__ __launch_bounds__(50) void matmul_B16_test(float* __restrict__ data, float* __restrict__ weight, float* __restrict__ T_matmul_NT) {
