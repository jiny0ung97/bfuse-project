...
extern "C" __global__ void __launch_bounds__(256) conv2d_shared_4096(float* __restrict__ A, float* __restrict__ B, float* __restrict__ W) {
  ...
  __shared__ float W_shared[2048];//
...
extern "C" __global__ void __launch_bounds__(256) conv2d_shared_4096_copy(float* __restrict__ A, float* __restrict__ B, float* __restrict__ W) {
  float B_local[64];
  __shared__ float Apad_shared[2048];//
  __shared__ float W_shared[2048];//
  float Apad_shared_local[8];
