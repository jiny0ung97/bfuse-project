...
extern "C" __global__ __launch_bounds__(256) void conv2d_shared_2048_conv2d_shared_2048_copy_fused_kernel_bfuse_idx_0(float *__restrict conv2d_shared_2048_A_, float *__restrict conv2d_shared_2048_B_, float *__restrict conv2d_shared_2048_W_, float *__restrict conv2d_shared_2048_copy_A_, float *__restrict conv2d_shared_2048_copy_B_, float *__restrict conv2d_shared_2048_copy_W_)
{
  /*
   * KernelID_ means...
   * 0: conv2d_shared_2048
   * 1: conv2d_shared_2048_copy
   */
  int gridDim_x_;
  int blockIdx_x_;
  int NewBlockIdx_;
  ...
  else if ((KernelID_ == 1) && (((int)threadIdx.x >= 0 && (int)threadIdx.x < 256)))
  {
      ...
      for (int rc_outer = 0; rc_outer < 32; ++rc_outer) {
          for (int ry = 0; ry < 3; ++ry) {
              for (int rx = 0; rx < 3; ++rx) {
                  ...
                  for (int ax3_inner_outer = 0; ax3_inner_outer < 2; ++ax3_inner_outer) {
                      if (((int)threadIdx.x) < 128) {
                          *(float4 *)(union_shared_0_ + ((((int)threadIdx.x) * 8) + (ax3_inner_outer * 4))) = (((((1 <= ((((int)blockIdx_x_) / 112) + ry)) && (((((int)blockIdx_x_) / 112) + ry) < 15)) && (1 <= (((((int)blockIdx_x_) % 112) >> 3) + rx))) && ((((((int)blockIdx_x_) % 112) >> 3) + rx) < 15)) ? *(float4 *)(conv2d_shared_2048_copy_A_ + (((((((((ry * 917504) + ((((int)blockIdx_x_) >> 3) * 65536)) + (rx * 65536)) + (rc_outer * 2048)) + ((((int)threadIdx.x) >> 4) * 256)) + ((((int)blockIdx_x_) & 1) * 128)) + ((((int)threadIdx.x) & 15) * 8)) + (ax3_inner_outer * 4)) - 983040)) : make_float4(0.F, 0.F, 0.F, 0.F));
                      }
                  }
                  for (int ax3_inner_outer_1 = 0; ax3_inner_outer_1 < 2; ++ax3_inner_outer_1) {
                      if (((int)threadIdx.x) < 128) {
                          *(float4 *)(union_shared_1_ + ((((int)threadIdx.x) * 8) + (ax3_inner_outer_1 * 4))) = *(float4 *)(conv2d_shared_2048_copy_W_ + (((((((ry * 393216) + (rx * 131072)) + (rc_outer * 4096)) + ((((int)threadIdx.x) >> 4) * 512)) + (((((int)blockIdx_x_) & 7) >> 1) * 128)) + ((((int)threadIdx.x) & 15) * 8)) + (ax3_inner_outer_1 * 4)));
                      }
                  }
                  asm ("bar.sync 0, 256;");
                  for (int rc_inner = 0; rc_inner < 8; ++rc_inner) {
      ...
      for (int ff_inner_inner_inner = 0; ff_inner_inner_inner < 4; ++ff_inner_inner_inner) {
          for (int nn_inner_inner_inner = 0; nn_inner_inner_inner < 4; ++nn_inner_inner_inner) {
              conv2d_shared_2048_copy_B_[(((((((((int)blockIdx_x_) >> 1) * 32768) + ((((int)threadIdx.x) >> 4) * 1024)) + (ff_inner_inner_inner * 256)) + ((((int)blockIdx_x_) & 1) * 128)) + ((((int)threadIdx.x) & 15) * 4)) + nn_inner_inner_inner)] = B_local[((ff_inner_inner_inner * 4) + nn_inner_inner_inner)];
              conv2d_shared_2048_copy_B_[((((((((((int)blockIdx_x_) >> 1) * 32768) + ((((int)threadIdx.x) >> 4) * 1024)) + (ff_inner_inner_inner * 256)) + ((((int)blockIdx_x_) & 1) * 128)) + ((((int)threadIdx.x) & 15) * 4)) + nn_inner_inner_inner) + 16384)] = B_local[(((ff_inner_inner_inner * 4) + nn_inner_inner_inner) + 32)];
              conv2d_shared_2048_copy_B_[((((((((((int)blockIdx_x_) >> 1) * 32768) + ((((int)threadIdx.x) >> 4) * 1024)) + (ff_inner_inner_inner * 256)) + ((((int)blockIdx_x_) & 1) * 128)) + ((((int)threadIdx.x) & 15) * 4)) + nn_inner_inner_inner) + 64)] = B_local[(((ff_inner_inner_inner * 4) + nn_inner_inner_inner) + 16)];
              conv2d_shared_2048_copy_B_[((((((((((int)blockIdx_x_) >> 1) * 32768) + ((((int)threadIdx.x) >> 4) * 1024)) + (ff_inner_inner_inner * 256)) + ((((int)blockIdx_x_) & 1) * 128)) + ((((int)threadIdx.x) & 15) * 4)) + nn_inner_inner_inner) + 16448)] = B_local[(((ff_inner_inner_inner * 4) + nn_inner_inner_inner) + 48)];
          }
      }
  }
}
