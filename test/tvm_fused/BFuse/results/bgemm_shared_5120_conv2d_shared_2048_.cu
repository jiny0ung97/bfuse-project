...
extern "C" __global__ __launch_bounds__(256) void bgemm_shared_5120_conv2d_shared_2048_fused_kernel_bfuse_idx_0(float *__restrict bgemm_shared_5120_A_, float *__restrict bgemm_shared_5120_B_, float *__restrict bgemm_shared_5120_T_batch_matmul_NT_, float *__restrict conv2d_shared_2048_A_, float *__restrict conv2d_shared_2048_B_, float *__restrict conv2d_shared_2048_W_)
{
  ...
  else if (((int)blockIdx.x >= 3024 && (int)blockIdx.x < 34272) && ((((int)blockIdx.x - 3024) / 84) % 1 == 0))
  {
    NewBlockIdx_ = 1512 + (((int)blockIdx.x - 3024) / 84) * 84 + (int)blockIdx.x % 84;
    KernelID_  = 0;
    gridDim_x_ = 32768;
  }
  else if ((int)blockIdx.x >= 34272 && (int)blockIdx.x < 34328)
  {
    NewBlockIdx_ = (int)blockIdx.x - 32760;
    KernelID_  = 1;
    gridDim_x_ = 1568;
  }
  else if ((int)blockIdx.x >= 34328 && (int)blockIdx.x < 34336)
  {
  ...
  else if ((KernelID_ == 1) && (((int)threadIdx.x >= 0 && (int)threadIdx.x < 256)))
  {
      ...
      for (int ff_inner_inner_inner = 0; ff_inner_inner_inner < 4; ++ff_inner_inner_inner) {
          for (int nn_inner_inner_inner = 0; nn_inner_inner_inner < 4; ++nn_inner_inner_inner) {
              conv2d_shared_2048_B_[(((((((((int)blockIdx_x_) >> 1) * 32768) + ((((int)threadIdx.x) >> 4) * 1024)) + (ff_inner_inner_inner * 256)) + ((((int)blockIdx_x_) & 1) * 128)) + ((((int)threadIdx.x) & 15) * 4)) + nn_inner_inner_inner)] = B_local[((ff_inner_inner_inner * 4) + nn_inner_inner_inner)];
              conv2d_shared_2048_B_[((((((((((int)blockIdx_x_) >> 1) * 32768) + ((((int)threadIdx.x) >> 4) * 1024)) + (ff_inner_inner_inner * 256)) + ((((int)blockIdx_x_) & 1) * 128)) + ((((int)threadIdx.x) & 15) * 4)) + nn_inner_inner_inner) + 16384)] = B_local[(((ff_inner_inner_inner * 4) + nn_inner_inner_inner) + 32)];
              conv2d_shared_2048_B_[((((((((((int)blockIdx_x_) >> 1) * 32768) + ((((int)threadIdx.x) >> 4) * 1024)) + (ff_inner_inner_inner * 256)) + ((((int)blockIdx_x_) & 1) * 128)) + ((((int)threadIdx.x) & 15) * 4)) + nn_inner_inner_inner) + 64)] = B_local[(((ff_inner_inner_inner * 4) + nn_inner_inner_inner) + 16)];
              conv2d_shared_2048_B_[((((((((((int)blockIdx_x_) >> 1) * 32768) + ((((int)threadIdx.x) >> 4) * 1024)) + (ff_inner_inner_inner * 256)) + ((((int)blockIdx_x_) & 1) * 128)) + ((((int)threadIdx.x) & 15) * 4)) + nn_inner_inner_inner) + 16448)] = B_local[(((ff_inner_inner_inner * 4) + nn_inner_inner_inner) + 48)];
          }
      }
  }
}
