...
__device__ void bgemm_0_conv2d_3_bfuse_device_0(int blockIdx_, int threadIdx_, float *__restrict bgemm_0_A_, float *__restrict bgemm_0_B_, float *__restrict bgemm_0_T_batch_matmul_NT_, volatile bgemm_0_conv2d_3_Ty_ *SU_)
{
    int gridDim_x_  = 8;
    int gridDim_y_  = 8;
    int gridDim_z_  = 32;
...
__device__ void bgemm_0_conv2d_3_bfuse_device_1(int blockIdx_, int threadIdx_, float *__restrict conv2d_3_conv2d_nchw_, float *__restrict conv2d_3_data_, float *__restrict conv2d_3_kernel_, volatile bgemm_0_conv2d_3_Ty_ *SU_)
{
    int gridDim_x_  = 2;
    int gridDim_y_  = 13;
    int gridDim_z_  = 16;
...
extern "C" __global__ __launch_bounds__(104) void bgemm_0_conv2d_3_fused_bfuse(float *__restrict bgemm_0_A_, float *__restrict bgemm_0_B_, float *__restrict bgemm_0_T_batch_matmul_NT_, float *__restrict conv2d_3_conv2d_nchw_, float *__restrict conv2d_3_data_, float *__restrict conv2d_3_kernel_)
{
  ...
  if (((int)blockIdx.x >= 0 && (int)blockIdx.x < 84) && ((int)threadIdx.x < 64))
  {
    ...
    for (int Idx = startBlockBound; Idx < endBlockBound; ++Idx) {
        bgemm_0_conv2d_3_bfuse_device_0(Idx, (int)threadIdx.x, bgemm_0_A_, bgemm_0_B_, bgemm_0_T_batch_matmul_NT_, &SU_);
    }
  }
  // conv2d_3
  // GridSize  = 416
  ...
  else if (((int)blockIdx.x >= 84 && (int)blockIdx.x < 168) && ((int)threadIdx.x < 104))
  {
    ...
    for (int Idx = startBlockBound; Idx < endBlockBound; ++Idx) {
        bgemm_0_conv2d_3_bfuse_device_1(Idx, (int)threadIdx.x, conv2d_3_conv2d_nchw_, conv2d_3_data_, conv2d_3_kernel_, &SU_);
    }
  }
}
...
__device__ void bgemm_1_conv2d_3_bfuse_device_0(int blockIdx_, int threadIdx_, float *__restrict bgemm_1_A_, float *__restrict bgemm_1_B_, float *__restrict bgemm_1_T_batch_matmul_NT_, volatile bgemm_1_conv2d_3_Ty_ *SU_)
{
    int gridDim_x_  = 1;
    int gridDim_y_  = 8;
    int gridDim_z_  = 32;
    ...
    for (int k_outer = 0; k_outer < 64; ++k_outer) {
        __syncthreads();
        SU_->bgemm_1.A_shared[((((int)threadIdx_y_) * 64) + ((int)threadIdx_x_))] = bgemm_1_A_[(((((((int)blockIdx_z_) * 262144) + (((int)blockIdx_y_) * 32768)) + (((int)threadIdx_y_) * 4096)) + (k_outer * 8)) + ((int)threadIdx_x_))];
        SU_->bgemm_1.A_shared[(((((int)threadIdx_y_) * 64) + ((int)threadIdx_x_)) + 8)] = bgemm_1_A_[((((((((int)blockIdx_z_) * 262144) + (((int)blockIdx_y_) * 32768)) + (((int)threadIdx_y_) * 4096)) + (k_outer * 8)) + ((int)threadIdx_x_)) + 512)];
        SU_->bgemm_1.A_shared[(((((int)threadIdx_y_) * 64) + ((int)threadIdx_x_)) + 16)] = bgemm_1_A_[((((((((int)blockIdx_z_) * 262144) + (((int)blockIdx_y_) * 32768)) + (((int)threadIdx_y_) * 4096)) + (k_outer * 8)) + ((int)threadIdx_x_)) + 1024)];
        SU_->bgemm_1.A_shared[(((((int)threadIdx_y_) * 64) + ((int)threadIdx_x_)) + 24)] = bgemm_1_A_[((((((((int)blockIdx_z_) * 262144) + (((int)blockIdx_y_) * 32768)) + (((int)threadIdx_y_) * 4096)) + (k_outer * 8)) + ((int)threadIdx_x_)) + 1536)];
        SU_->bgemm_1.A_shared[(((((int)threadIdx_y_) * 64) + ((int)threadIdx_x_)) + 32)] = bgemm_1_A_[((((((((int)blockIdx_z_) * 262144) + (((int)blockIdx_y_) * 32768)) + (((int)threadIdx_y_) * 4096)) + (k_outer * 8)) + ((int)threadIdx_x_)) + 2048)];
        SU_->bgemm_1.A_shared[(((((int)threadIdx_y_) * 64) + ((int)threadIdx_x_)) + 40)] = bgemm_1_A_[((((((((int)blockIdx_z_) * 262144) + (((int)blockIdx_y_) * 32768)) + (((int)threadIdx_y_) * 4096)) + (k_outer * 8)) + ((int)threadIdx_x_)) + 2560)];
        SU_->bgemm_1.A_shared[(((((int)threadIdx_y_) * 64) + ((int)threadIdx_x_)) + 48)] = bgemm_1_A_[((((((((int)blockIdx_z_) * 262144) + (((int)blockIdx_y_) * 32768)) + (((int)threadIdx_y_) * 4096)) + (k_outer * 8)) + ((int)threadIdx_x_)) + 3072)];
        SU_->bgemm_1.A_shared[(((((int)threadIdx_y_) * 64) + ((int)threadIdx_x_)) + 56)] = bgemm_1_A_[((((((((int)blockIdx_z_) * 262144) + (((int)blockIdx_y_) * 32768)) + (((int)threadIdx_y_) * 4096)) + (k_outer * 8)) + ((int)threadIdx_x_)) + 3584)];
        SU_->bgemm_1.B_shared[((((int)threadIdx_y_) * 64) + ((int)threadIdx_x_))] = bgemm_1_B_[((((((int)blockIdx_z_) * 32768) + (((int)threadIdx_y_) * 4096)) + (k_outer * 8)) + ((int)threadIdx_x_))];
        SU_->bgemm_1.B_shared[(((((int)threadIdx_y_) * 64) + ((int)threadIdx_x_)) + 8)] = bgemm_1_B_[(((((((int)blockIdx_z_) * 32768) + (((int)threadIdx_y_) * 4096)) + (k_outer * 8)) + ((int)threadIdx_x_)) + 512)];
        SU_->bgemm_1.B_shared[(((((int)threadIdx_y_) * 64) + ((int)threadIdx_x_)) + 16)] = bgemm_1_B_[(((((((int)blockIdx_z_) * 32768) + (((int)threadIdx_y_) * 4096)) + (k_outer * 8)) + ((int)threadIdx_x_)) + 1024)];
        SU_->bgemm_1.B_shared[(((((int)threadIdx_y_) * 64) + ((int)threadIdx_x_)) + 24)] = bgemm_1_B_[(((((((int)blockIdx_z_) * 32768) + (((int)threadIdx_y_) * 4096)) + (k_outer * 8)) + ((int)threadIdx_x_)) + 1536)];
        SU_->bgemm_1.B_shared[(((((int)threadIdx_y_) * 64) + ((int)threadIdx_x_)) + 32)] = bgemm_1_B_[(((((((int)blockIdx_z_) * 32768) + (((int)threadIdx_y_) * 4096)) + (k_outer * 8)) + ((int)threadIdx_x_)) + 2048)];
        SU_->bgemm_1.B_shared[(((((int)threadIdx_y_) * 64) + ((int)threadIdx_x_)) + 40)] = bgemm_1_B_[(((((((int)blockIdx_z_) * 32768) + (((int)threadIdx_y_) * 4096)) + (k_outer * 8)) + ((int)threadIdx_x_)) + 2560)];
        SU_->bgemm_1.B_shared[(((((int)threadIdx_y_) * 64) + ((int)threadIdx_x_)) + 48)] = bgemm_1_B_[(((((((int)blockIdx_z_) * 32768) + (((int)threadIdx_y_) * 4096)) + (k_outer * 8)) + ((int)threadIdx_x_)) + 3072)];
        SU_->bgemm_1.B_shared[(((((int)threadIdx_y_) * 64) + ((int)threadIdx_x_)) + 56)] = bgemm_1_B_[(((((((int)blockIdx_z_) * 32768) + (((int)threadIdx_y_) * 4096)) + (k_outer * 8)) + ((int)threadIdx_x_)) + 3584)];
        __syncthreads();
        for (int k_inner = 0; k_inner < 8; ++k_inner) {
            A_shared_local[0] = SU_->bgemm_1.A_shared[((((int)threadIdx_y_) * 64) + k_inner)];
            A_shared_local[1] = SU_->bgemm_1.A_shared[(((((int)threadIdx_y_) * 64) + k_inner) + 8)];
            A_shared_local[2] = SU_->bgemm_1.A_shared[(((((int)threadIdx_y_) * 64) + k_inner) + 16)];
            A_shared_local[3] = SU_->bgemm_1.A_shared[(((((int)threadIdx_y_) * 64) + k_inner) + 24)];
            A_shared_local[4] = SU_->bgemm_1.A_shared[(((((int)threadIdx_y_) * 64) + k_inner) + 32)];
            A_shared_local[5] = SU_->bgemm_1.A_shared[(((((int)threadIdx_y_) * 64) + k_inner) + 40)];
            A_shared_local[6] = SU_->bgemm_1.A_shared[(((((int)threadIdx_y_) * 64) + k_inner) + 48)];
            A_shared_local[7] = SU_->bgemm_1.A_shared[(((((int)threadIdx_y_) * 64) + k_inner) + 56)];
            B_shared_local[0] = SU_->bgemm_1.B_shared[((((int)threadIdx_x_) * 64) + k_inner)];
            B_shared_local[1] = SU_->bgemm_1.B_shared[(((((int)threadIdx_x_) * 64) + k_inner) + 8)];
            B_shared_local[2] = SU_->bgemm_1.B_shared[(((((int)threadIdx_x_) * 64) + k_inner) + 16)];
            B_shared_local[3] = SU_->bgemm_1.B_shared[(((((int)threadIdx_x_) * 64) + k_inner) + 24)];
            B_shared_local[4] = SU_->bgemm_1.B_shared[(((((int)threadIdx_x_) * 64) + k_inner) + 32)];
            B_shared_local[5] = SU_->bgemm_1.B_shared[(((((int)threadIdx_x_) * 64) + k_inner) + 40)];
            B_shared_local[6] = SU_->bgemm_1.B_shared[(((((int)threadIdx_x_) * 64) + k_inner) + 48)];
            B_shared_local[7] = SU_->bgemm_1.B_shared[(((((int)threadIdx_x_) * 64) + k_inner) + 56)];
            for (int i_c = 0; i_c < 8; ++i_c) {
                T_batch_matmul_NT_local[(i_c * 8)] = (T_batch_matmul_NT_local[(i_c * 8)] + (A_shared_local[i_c] * B_shared_local[0]));
                T_batch_matmul_NT_local[((i_c * 8) + 1)] = (T_batch_matmul_NT_local[((i_c * 8) + 1)] + (A_shared_local[i_c] * B_shared_local[1]));
                T_batch_matmul_NT_local[((i_c * 8) + 2)] = (T_batch_matmul_NT_local[((i_c * 8) + 2)] + (A_shared_local[i_c] * B_shared_local[2]));
...
__device__ void bgemm_1_conv2d_3_bfuse_device_1(int blockIdx_, int threadIdx_, float *__restrict conv2d_3_conv2d_nchw_, float *__restrict conv2d_3_data_, float *__restrict conv2d_3_kernel_, volatile bgemm_1_conv2d_3_Ty_ *SU_)
{
    int gridDim_x_  = 2;
    int gridDim_y_  = 13;
    int gridDim_z_  = 16;
...
extern "C" __global__ __launch_bounds__(104) void bgemm_1_conv2d_3_fused_bfuse(float *__restrict bgemm_1_A_, float *__restrict bgemm_1_B_, float *__restrict bgemm_1_T_batch_matmul_NT_, float *__restrict conv2d_3_conv2d_nchw_, float *__restrict conv2d_3_data_, float *__restrict conv2d_3_kernel_)
{
  ...
  if (((int)blockIdx.x >= 0 && (int)blockIdx.x < 84) && ((int)threadIdx.x < 64))
  {
    ...
    for (int Idx = startBlockBound; Idx < endBlockBound; ++Idx) {
        bgemm_1_conv2d_3_bfuse_device_0(Idx, (int)threadIdx.x, bgemm_1_A_, bgemm_1_B_, bgemm_1_T_batch_matmul_NT_, &SU_);
    }
  }
  // conv2d_3
  // GridSize  = 416
  ...
  else if (((int)blockIdx.x >= 84 && (int)blockIdx.x < 168) && ((int)threadIdx.x < 104))
  {
    ...
    for (int Idx = startBlockBound; Idx < endBlockBound; ++Idx) {
        bgemm_1_conv2d_3_bfuse_device_1(Idx, (int)threadIdx.x, conv2d_3_conv2d_nchw_, conv2d_3_data_, conv2d_3_kernel_, &SU_);
    }
  }
}
...
__device__ void bgemm_2_conv2d_3_bfuse_device_0(int blockIdx_, int threadIdx_, float *__restrict bgemm_2_A_, float *__restrict bgemm_2_B_, float *__restrict bgemm_2_T_batch_matmul_NT_, volatile bgemm_2_conv2d_3_Ty_ *SU_)
{
    int gridDim_x_  = 4;
    int gridDim_y_  = 4;
    int gridDim_z_  = 32;
    ...
    for (int k_outer = 0; k_outer < 10; ++k_outer) {
        __syncthreads();
        SU_->bgemm_2.A_shared[((((int)threadIdx_y_) * 64) + ((int)threadIdx_x_))] = bgemm_2_A_[(((((((int)blockIdx_z_) * 20480) + (((int)blockIdx_y_) * 5120)) + (((int)threadIdx_y_) * 640)) + (k_outer * 8)) + ((int)threadIdx_x_))];
        SU_->bgemm_2.A_shared[(((((int)threadIdx_y_) * 64) + ((int)threadIdx_x_)) + 8)] = bgemm_2_A_[((((((((int)blockIdx_z_) * 20480) + (((int)blockIdx_y_) * 5120)) + (((int)threadIdx_y_) * 640)) + (k_outer * 8)) + ((int)threadIdx_x_)) + 80)];
        SU_->bgemm_2.A_shared[(((((int)threadIdx_y_) * 64) + ((int)threadIdx_x_)) + 16)] = bgemm_2_A_[((((((((int)blockIdx_z_) * 20480) + (((int)blockIdx_y_) * 5120)) + (((int)threadIdx_y_) * 640)) + (k_outer * 8)) + ((int)threadIdx_x_)) + 160)];
        SU_->bgemm_2.A_shared[(((((int)threadIdx_y_) * 64) + ((int)threadIdx_x_)) + 24)] = bgemm_2_A_[((((((((int)blockIdx_z_) * 20480) + (((int)blockIdx_y_) * 5120)) + (((int)threadIdx_y_) * 640)) + (k_outer * 8)) + ((int)threadIdx_x_)) + 240)];
        SU_->bgemm_2.A_shared[(((((int)threadIdx_y_) * 64) + ((int)threadIdx_x_)) + 32)] = bgemm_2_A_[((((((((int)blockIdx_z_) * 20480) + (((int)blockIdx_y_) * 5120)) + (((int)threadIdx_y_) * 640)) + (k_outer * 8)) + ((int)threadIdx_x_)) + 320)];
        SU_->bgemm_2.A_shared[(((((int)threadIdx_y_) * 64) + ((int)threadIdx_x_)) + 40)] = bgemm_2_A_[((((((((int)blockIdx_z_) * 20480) + (((int)blockIdx_y_) * 5120)) + (((int)threadIdx_y_) * 640)) + (k_outer * 8)) + ((int)threadIdx_x_)) + 400)];
        SU_->bgemm_2.A_shared[(((((int)threadIdx_y_) * 64) + ((int)threadIdx_x_)) + 48)] = bgemm_2_A_[((((((((int)blockIdx_z_) * 20480) + (((int)blockIdx_y_) * 5120)) + (((int)threadIdx_y_) * 640)) + (k_outer * 8)) + ((int)threadIdx_x_)) + 480)];
        SU_->bgemm_2.A_shared[(((((int)threadIdx_y_) * 64) + ((int)threadIdx_x_)) + 56)] = bgemm_2_A_[((((((((int)blockIdx_z_) * 20480) + (((int)blockIdx_y_) * 5120)) + (((int)threadIdx_y_) * 640)) + (k_outer * 8)) + ((int)threadIdx_x_)) + 560)];
        SU_->bgemm_2.B_shared[((((int)threadIdx_y_) * 64) + ((int)threadIdx_x_))] = bgemm_2_B_[(((((((int)blockIdx_z_) * 20480) + (((int)blockIdx_x_) * 5120)) + (((int)threadIdx_y_) * 640)) + (k_outer * 8)) + ((int)threadIdx_x_))];
        SU_->bgemm_2.B_shared[(((((int)threadIdx_y_) * 64) + ((int)threadIdx_x_)) + 8)] = bgemm_2_B_[((((((((int)blockIdx_z_) * 20480) + (((int)blockIdx_x_) * 5120)) + (((int)threadIdx_y_) * 640)) + (k_outer * 8)) + ((int)threadIdx_x_)) + 80)];
        SU_->bgemm_2.B_shared[(((((int)threadIdx_y_) * 64) + ((int)threadIdx_x_)) + 16)] = bgemm_2_B_[((((((((int)blockIdx_z_) * 20480) + (((int)blockIdx_x_) * 5120)) + (((int)threadIdx_y_) * 640)) + (k_outer * 8)) + ((int)threadIdx_x_)) + 160)];
        SU_->bgemm_2.B_shared[(((((int)threadIdx_y_) * 64) + ((int)threadIdx_x_)) + 24)] = bgemm_2_B_[((((((((int)blockIdx_z_) * 20480) + (((int)blockIdx_x_) * 5120)) + (((int)threadIdx_y_) * 640)) + (k_outer * 8)) + ((int)threadIdx_x_)) + 240)];
        SU_->bgemm_2.B_shared[(((((int)threadIdx_y_) * 64) + ((int)threadIdx_x_)) + 32)] = bgemm_2_B_[((((((((int)blockIdx_z_) * 20480) + (((int)blockIdx_x_) * 5120)) + (((int)threadIdx_y_) * 640)) + (k_outer * 8)) + ((int)threadIdx_x_)) + 320)];
        SU_->bgemm_2.B_shared[(((((int)threadIdx_y_) * 64) + ((int)threadIdx_x_)) + 40)] = bgemm_2_B_[((((((((int)blockIdx_z_) * 20480) + (((int)blockIdx_x_) * 5120)) + (((int)threadIdx_y_) * 640)) + (k_outer * 8)) + ((int)threadIdx_x_)) + 400)];
        SU_->bgemm_2.B_shared[(((((int)threadIdx_y_) * 64) + ((int)threadIdx_x_)) + 48)] = bgemm_2_B_[((((((((int)blockIdx_z_) * 20480) + (((int)blockIdx_x_) * 5120)) + (((int)threadIdx_y_) * 640)) + (k_outer * 8)) + ((int)threadIdx_x_)) + 480)];
        SU_->bgemm_2.B_shared[(((((int)threadIdx_y_) * 64) + ((int)threadIdx_x_)) + 56)] = bgemm_2_B_[((((((((int)blockIdx_z_) * 20480) + (((int)blockIdx_x_) * 5120)) + (((int)threadIdx_y_) * 640)) + (k_outer * 8)) + ((int)threadIdx_x_)) + 560)];
        __syncthreads();
        for (int k_inner = 0; k_inner < 8; ++k_inner) {
            A_shared_local[0] = SU_->bgemm_2.A_shared[((((int)threadIdx_y_) * 64) + k_inner)];
            A_shared_local[1] = SU_->bgemm_2.A_shared[(((((int)threadIdx_y_) * 64) + k_inner) + 8)];
            A_shared_local[2] = SU_->bgemm_2.A_shared[(((((int)threadIdx_y_) * 64) + k_inner) + 16)];
            A_shared_local[3] = SU_->bgemm_2.A_shared[(((((int)threadIdx_y_) * 64) + k_inner) + 24)];
            A_shared_local[4] = SU_->bgemm_2.A_shared[(((((int)threadIdx_y_) * 64) + k_inner) + 32)];
            A_shared_local[5] = SU_->bgemm_2.A_shared[(((((int)threadIdx_y_) * 64) + k_inner) + 40)];
            A_shared_local[6] = SU_->bgemm_2.A_shared[(((((int)threadIdx_y_) * 64) + k_inner) + 48)];
            A_shared_local[7] = SU_->bgemm_2.A_shared[(((((int)threadIdx_y_) * 64) + k_inner) + 56)];
            B_shared_local[0] = SU_->bgemm_2.B_shared[((((int)threadIdx_x_) * 64) + k_inner)];
            B_shared_local[1] = SU_->bgemm_2.B_shared[(((((int)threadIdx_x_) * 64) + k_inner) + 8)];
            B_shared_local[2] = SU_->bgemm_2.B_shared[(((((int)threadIdx_x_) * 64) + k_inner) + 16)];
            B_shared_local[3] = SU_->bgemm_2.B_shared[(((((int)threadIdx_x_) * 64) + k_inner) + 24)];
            B_shared_local[4] = SU_->bgemm_2.B_shared[(((((int)threadIdx_x_) * 64) + k_inner) + 32)];
            B_shared_local[5] = SU_->bgemm_2.B_shared[(((((int)threadIdx_x_) * 64) + k_inner) + 40)];
            B_shared_local[6] = SU_->bgemm_2.B_shared[(((((int)threadIdx_x_) * 64) + k_inner) + 48)];
            B_shared_local[7] = SU_->bgemm_2.B_shared[(((((int)threadIdx_x_) * 64) + k_inner) + 56)];
            for (int i_c = 0; i_c < 8; ++i_c) {
                T_batch_matmul_NT_local[(i_c * 8)] = (T_batch_matmul_NT_local[(i_c * 8)] + (A_shared_local[i_c] * B_shared_local[0]));
                T_batch_matmul_NT_local[((i_c * 8) + 1)] = (T_batch_matmul_NT_local[((i_c * 8) + 1)] + (A_shared_local[i_c] * B_shared_local[1]));
                T_batch_matmul_NT_local[((i_c * 8) + 2)] = (T_batch_matmul_NT_local[((i_c * 8) + 2)] + (A_shared_local[i_c] * B_shared_local[2]));
...
__device__ void bgemm_2_conv2d_3_bfuse_device_1(int blockIdx_, int threadIdx_, float *__restrict conv2d_3_conv2d_nchw_, float *__restrict conv2d_3_data_, float *__restrict conv2d_3_kernel_, volatile bgemm_2_conv2d_3_Ty_ *SU_)
{
    int gridDim_x_  = 2;
    int gridDim_y_  = 13;
    int gridDim_z_  = 16;
...
extern "C" __global__ __launch_bounds__(104) void bgemm_2_conv2d_3_fused_bfuse(float *__restrict bgemm_2_A_, float *__restrict bgemm_2_B_, float *__restrict bgemm_2_T_batch_matmul_NT_, float *__restrict conv2d_3_conv2d_nchw_, float *__restrict conv2d_3_data_, float *__restrict conv2d_3_kernel_)
{
  ...
  if (((int)blockIdx.x >= 0 && (int)blockIdx.x < 84) && ((int)threadIdx.x < 64))
  {
    ...
    for (int Idx = startBlockBound; Idx < endBlockBound; ++Idx) {
        bgemm_2_conv2d_3_bfuse_device_0(Idx, (int)threadIdx.x, bgemm_2_A_, bgemm_2_B_, bgemm_2_T_batch_matmul_NT_, &SU_);
    }
  }
  // conv2d_3
  // GridSize  = 416
  ...
  else if (((int)blockIdx.x >= 84 && (int)blockIdx.x < 168) && ((int)threadIdx.x < 104))
  {
    ...
    for (int Idx = startBlockBound; Idx < endBlockBound; ++Idx) {
        bgemm_2_conv2d_3_bfuse_device_1(Idx, (int)threadIdx.x, conv2d_3_conv2d_nchw_, conv2d_3_data_, conv2d_3_kernel_, &SU_);
    }
  }
}
