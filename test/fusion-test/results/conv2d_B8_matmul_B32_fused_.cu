...
#endif
extern "C" __global__ __launch_bounds__(128) conv2d_B8_matmul_B32_fused_(float *__restrict conv2d_B8_data_, float *__restrict conv2d_B8_kernel_, float *__restrict conv2d_B8_conv2d_nhwc_, float *__restrict matmul_B32_data_, float *__restrict matmul_B32_weight_, float *__restrict matmul_B32_T_matmul_NT_)
{
