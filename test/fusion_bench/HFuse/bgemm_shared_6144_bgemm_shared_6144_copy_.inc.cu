 __global__ __launch_bounds__(128, 8) void bgemm_shared_6144_bgemm_shared_6144_copy_fused_kernel_vfuse_lb_idx_0(float *__restrict A0, float *__restrict B1, float *__restrict T_batch_matmul_NT2, float *__restrict A6, float *__restrict B7, float *__restrict T_batch_matmul_NT8)
 {
if (((threadIdx.x + threadIdx.y * blockDim.x + threadIdx.z * blockDim.x * blockDim.y)>=0 && (threadIdx.x + threadIdx.y * blockDim.x + threadIdx.z * blockDim.x * blockDim.y) < 128)){
    ...
    static float B_shared5[2048] __attribute__((shared));
...
if (((threadIdx.x + threadIdx.y * blockDim.x + threadIdx.z * blockDim.x * blockDim.y)>=0 && (threadIdx.x + threadIdx.y * blockDim.x + threadIdx.z * blockDim.x * blockDim.y) < 128)){
    ...
    static float B_shared11[2048] __attribute__((shared));
    for (int i_c_outer_inner_init = 0; i_c_outer_inner_init < 2; ++i_c_outer_inner_init) {
 ...
 __global__ __launch_bounds__(128, 0) void bgemm_shared_6144_bgemm_shared_6144_copy_fused_kernel_vfuse_idx_0(float *__restrict A0, float *__restrict B1, float *__restrict T_batch_matmul_NT2, float *__restrict A6, float *__restrict B7, float *__restrict T_batch_matmul_NT8)
 {
if (((threadIdx.x + threadIdx.y * blockDim.x + threadIdx.z * blockDim.x * blockDim.y)>=0 && (threadIdx.x + threadIdx.y * blockDim.x + threadIdx.z * blockDim.x * blockDim.y) < 128)){
    unsigned int blockDim_x_0 = 128;
    unsigned int threadIdx_x_0 = ((threadIdx.x + threadIdx.y * blockDim.x + threadIdx.z * blockDim.x * blockDim.y) - 0) % 128;
...
if (((threadIdx.x + threadIdx.y * blockDim.x + threadIdx.z * blockDim.x * blockDim.y)>=0 && (threadIdx.x + threadIdx.y * blockDim.x + threadIdx.z * blockDim.x * blockDim.y) < 128)){
 ...
 __global__ __launch_bounds__(256, 0) void bgemm_shared_6144_bgemm_shared_6144_copy_fused_kernel_hfuse_idx_0(float *__restrict A0, float *__restrict B1, float *__restrict T_batch_matmul_NT2, float *__restrict A6, float *__restrict B7, float *__restrict T_batch_matmul_NT8)
 {
if (((threadIdx.x + threadIdx.y * blockDim.x + threadIdx.z * blockDim.x * blockDim.y)>=0 && (threadIdx.x + threadIdx.y * blockDim.x + threadIdx.z * blockDim.x * blockDim.y) < 128)){
    unsigned int blockDim_x_0 = 128;
    unsigned int threadIdx_x_0 = ((threadIdx.x + threadIdx.y * blockDim.x + threadIdx.z * blockDim.x * blockDim.y) - 0) % 128;
