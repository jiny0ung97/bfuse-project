extern "C" __global__ __launch_bounds__(96) void bgemm_0_conv2d_0_fused_hfuse(float *__restrict bgemm_0_A_, float *__restrict bgemm_0_B_, float *__restrict bgemm_0_T_batch_matmul_NT_, float *__restrict conv2d_0_conv2d_nchw_, float *__restrict conv2d_0_data_, float *__restrict conv2d_0_kernel_)
{
  ...
  // conv2d_0
  if (((int)threadIdx.x >= 64 && (int)threadIdx.x < 80) && ((int)blockIdx.x >= 0 && (int)blockIdx.x < 1858560))
  {
      ...
      for (int rc_outer = 0; rc_outer < 32; ++rc_outer) {
          ...
          if (((int)threadIdx_z_) < 9) {
              pad_temp_shared[(((int)threadIdx_z_) * 2)] = conv2d_0_data_[(((((((((int)blockIdx_z_) / 3) * 802816) + (rc_outer * 25088)) + (((((int)threadIdx_z_) * 2) / 9) * 12544)) + (((int)blockIdx_y_) * 1120)) + (((((int)threadIdx_z_) * 2) % 9) * 112)) + (((int)blockIdx_x_) * 2))];
          }
          if (((int)threadIdx_z_) < 9) {
              pad_temp_shared[((((int)threadIdx_z_) * 2) + 1)] = conv2d_0_data_[(((((((((int)blockIdx_z_) / 3) * 802816) + (rc_outer * 25088)) + ((((((int)threadIdx_z_) * 2) + 1) / 9) * 12544)) + (((int)blockIdx_y_) * 1120)) + ((((((int)threadIdx_z_) * 2) + 1) % 9) * 112)) + (((int)blockIdx_x_) * 2))];
          }
          kernel_shared[(((int)threadIdx_z_) * 8)] = conv2d_0_kernel_[((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18))];
          kernel_shared[((((int)threadIdx_z_) * 8) + 1)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 9)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 2)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 576)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 3)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 585)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 4)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 1152)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 5)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 1161)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 6)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 1728)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 7)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 1737)];
          asm ("bar.sync 2, 32;");
          ...
          asm ("bar.sync 2, 32;");
          if (((int)threadIdx_z_) < 9) {
              pad_temp_shared[(((int)threadIdx_z_) * 2)] = conv2d_0_data_[((((((((((int)blockIdx_z_) / 3) * 802816) + (rc_outer * 25088)) + (((((int)threadIdx_z_) * 2) / 9) * 12544)) + (((int)blockIdx_y_) * 1120)) + (((((int)threadIdx_z_) * 2) % 9) * 112)) + (((int)blockIdx_x_) * 2)) + 1)];
          }
          if (((int)threadIdx_z_) < 9) {
              pad_temp_shared[((((int)threadIdx_z_) * 2) + 1)] = conv2d_0_data_[((((((((((int)blockIdx_z_) / 3) * 802816) + (rc_outer * 25088)) + ((((((int)threadIdx_z_) * 2) + 1) / 9) * 12544)) + (((int)blockIdx_y_) * 1120)) + ((((((int)threadIdx_z_) * 2) + 1) % 9) * 112)) + (((int)blockIdx_x_) * 2)) + 1)];
          }
          kernel_shared[(((int)threadIdx_z_) * 8)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 1)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 1)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 10)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 2)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 577)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 3)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 586)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 4)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 1153)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 5)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 1162)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 6)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 1729)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 7)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 1738)];
          asm ("bar.sync 2, 32;");
          conv2d_nchw_local[0] = (conv2d_nchw_local[0] + (pad_temp_shared[0] * kernel_shared[(((int)threadIdx_z_) * 4)]));
          conv2d_nchw_local[10] = (conv2d_nchw_local[10] + (pad_temp_shared[0] * kernel_shared[((((int)threadIdx_z_) * 4) + 64)]));
          conv2d_nchw_local[2] = (conv2d_nchw_local[2] + (pad_temp_shared[2] * kernel_shared[(((int)threadIdx_z_) * 4)]));
          ...
          asm ("bar.sync 2, 32;");
          if (((int)threadIdx_z_) < 9) {
              pad_temp_shared[(((int)threadIdx_z_) * 2)] = conv2d_0_data_[((((((((((int)blockIdx_z_) / 3) * 802816) + (rc_outer * 25088)) + (((((int)threadIdx_z_) * 2) / 9) * 12544)) + (((int)blockIdx_y_) * 1120)) + (((((int)threadIdx_z_) * 2) % 9) * 112)) + (((int)blockIdx_x_) * 2)) + 2)];
          }
          if (((int)threadIdx_z_) < 9) {
              pad_temp_shared[((((int)threadIdx_z_) * 2) + 1)] = conv2d_0_data_[((((((((((int)blockIdx_z_) / 3) * 802816) + (rc_outer * 25088)) + ((((((int)threadIdx_z_) * 2) + 1) / 9) * 12544)) + (((int)blockIdx_y_) * 1120)) + ((((((int)threadIdx_z_) * 2) + 1) % 9) * 112)) + (((int)blockIdx_x_) * 2)) + 2)];
          }
          kernel_shared[(((int)threadIdx_z_) * 8)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 2)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 1)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 11)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 2)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 578)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 3)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 587)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 4)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 1154)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 5)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 1163)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 6)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 1730)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 7)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 1739)];
          asm ("bar.sync 2, 32;");
          conv2d_nchw_local[0] = (conv2d_nchw_local[0] + (pad_temp_shared[0] * kernel_shared[(((int)threadIdx_z_) * 4)]));
          conv2d_nchw_local[10] = (conv2d_nchw_local[10] + (pad_temp_shared[0] * kernel_shared[((((int)threadIdx_z_) * 4) + 64)]));
          conv2d_nchw_local[2] = (conv2d_nchw_local[2] + (pad_temp_shared[2] * kernel_shared[(((int)threadIdx_z_) * 4)]));
          ...
          asm ("bar.sync 2, 32;");
          if (((int)threadIdx_z_) < 9) {
              pad_temp_shared[(((int)threadIdx_z_) * 2)] = conv2d_0_data_[((((((((((int)blockIdx_z_) / 3) * 802816) + (rc_outer * 25088)) + (((((int)threadIdx_z_) * 2) / 9) * 12544)) + (((int)blockIdx_y_) * 1120)) + (((((int)threadIdx_z_) * 2) % 9) * 112)) + (((int)blockIdx_x_) * 2)) + 112)];
          }
          if (((int)threadIdx_z_) < 9) {
              pad_temp_shared[((((int)threadIdx_z_) * 2) + 1)] = conv2d_0_data_[((((((((((int)blockIdx_z_) / 3) * 802816) + (rc_outer * 25088)) + ((((((int)threadIdx_z_) * 2) + 1) / 9) * 12544)) + (((int)blockIdx_y_) * 1120)) + ((((((int)threadIdx_z_) * 2) + 1) % 9) * 112)) + (((int)blockIdx_x_) * 2)) + 112)];
          }
          kernel_shared[(((int)threadIdx_z_) * 8)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 3)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 1)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 12)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 2)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 579)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 3)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 588)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 4)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 1155)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 5)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 1164)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 6)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 1731)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 7)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 1740)];
          asm ("bar.sync 2, 32;");
          conv2d_nchw_local[0] = (conv2d_nchw_local[0] + (pad_temp_shared[0] * kernel_shared[(((int)threadIdx_z_) * 4)]));
          conv2d_nchw_local[10] = (conv2d_nchw_local[10] + (pad_temp_shared[0] * kernel_shared[((((int)threadIdx_z_) * 4) + 64)]));
          conv2d_nchw_local[2] = (conv2d_nchw_local[2] + (pad_temp_shared[2] * kernel_shared[(((int)threadIdx_z_) * 4)]));
          ...
          asm ("bar.sync 2, 32;");
          if (((int)threadIdx_z_) < 9) {
              pad_temp_shared[(((int)threadIdx_z_) * 2)] = conv2d_0_data_[((((((((((int)blockIdx_z_) / 3) * 802816) + (rc_outer * 25088)) + (((((int)threadIdx_z_) * 2) / 9) * 12544)) + (((int)blockIdx_y_) * 1120)) + (((((int)threadIdx_z_) * 2) % 9) * 112)) + (((int)blockIdx_x_) * 2)) + 113)];
          }
          if (((int)threadIdx_z_) < 9) {
              pad_temp_shared[((((int)threadIdx_z_) * 2) + 1)] = conv2d_0_data_[((((((((((int)blockIdx_z_) / 3) * 802816) + (rc_outer * 25088)) + ((((((int)threadIdx_z_) * 2) + 1) / 9) * 12544)) + (((int)blockIdx_y_) * 1120)) + ((((((int)threadIdx_z_) * 2) + 1) % 9) * 112)) + (((int)blockIdx_x_) * 2)) + 113)];
          }
          kernel_shared[(((int)threadIdx_z_) * 8)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 4)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 1)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 13)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 2)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 580)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 3)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 589)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 4)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 1156)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 5)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 1165)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 6)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 1732)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 7)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 1741)];
          asm ("bar.sync 2, 32;");
          conv2d_nchw_local[0] = (conv2d_nchw_local[0] + (pad_temp_shared[0] * kernel_shared[(((int)threadIdx_z_) * 4)]));
          conv2d_nchw_local[10] = (conv2d_nchw_local[10] + (pad_temp_shared[0] * kernel_shared[((((int)threadIdx_z_) * 4) + 64)]));
          conv2d_nchw_local[2] = (conv2d_nchw_local[2] + (pad_temp_shared[2] * kernel_shared[(((int)threadIdx_z_) * 4)]));
          ...
          asm ("bar.sync 2, 32;");
          if (((int)threadIdx_z_) < 9) {
              pad_temp_shared[(((int)threadIdx_z_) * 2)] = conv2d_0_data_[((((((((((int)blockIdx_z_) / 3) * 802816) + (rc_outer * 25088)) + (((((int)threadIdx_z_) * 2) / 9) * 12544)) + (((int)blockIdx_y_) * 1120)) + (((((int)threadIdx_z_) * 2) % 9) * 112)) + (((int)blockIdx_x_) * 2)) + 114)];
          }
          if (((int)threadIdx_z_) < 9) {
              pad_temp_shared[((((int)threadIdx_z_) * 2) + 1)] = conv2d_0_data_[((((((((((int)blockIdx_z_) / 3) * 802816) + (rc_outer * 25088)) + ((((((int)threadIdx_z_) * 2) + 1) / 9) * 12544)) + (((int)blockIdx_y_) * 1120)) + ((((((int)threadIdx_z_) * 2) + 1) % 9) * 112)) + (((int)blockIdx_x_) * 2)) + 114)];
          }
          kernel_shared[(((int)threadIdx_z_) * 8)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 5)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 1)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 14)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 2)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 581)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 3)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 590)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 4)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 1157)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 5)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 1166)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 6)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 1733)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 7)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 1742)];
          asm ("bar.sync 2, 32;");
          conv2d_nchw_local[0] = (conv2d_nchw_local[0] + (pad_temp_shared[0] * kernel_shared[(((int)threadIdx_z_) * 4)]));
          conv2d_nchw_local[10] = (conv2d_nchw_local[10] + (pad_temp_shared[0] * kernel_shared[((((int)threadIdx_z_) * 4) + 64)]));
          conv2d_nchw_local[2] = (conv2d_nchw_local[2] + (pad_temp_shared[2] * kernel_shared[(((int)threadIdx_z_) * 4)]));
          ...
          asm ("bar.sync 2, 32;");
          if (((int)threadIdx_z_) < 9) {
              pad_temp_shared[(((int)threadIdx_z_) * 2)] = conv2d_0_data_[((((((((((int)blockIdx_z_) / 3) * 802816) + (rc_outer * 25088)) + (((((int)threadIdx_z_) * 2) / 9) * 12544)) + (((int)blockIdx_y_) * 1120)) + (((((int)threadIdx_z_) * 2) % 9) * 112)) + (((int)blockIdx_x_) * 2)) + 224)];
          }
          if (((int)threadIdx_z_) < 9) {
              pad_temp_shared[((((int)threadIdx_z_) * 2) + 1)] = conv2d_0_data_[((((((((((int)blockIdx_z_) / 3) * 802816) + (rc_outer * 25088)) + ((((((int)threadIdx_z_) * 2) + 1) / 9) * 12544)) + (((int)blockIdx_y_) * 1120)) + ((((((int)threadIdx_z_) * 2) + 1) % 9) * 112)) + (((int)blockIdx_x_) * 2)) + 224)];
          }
          kernel_shared[(((int)threadIdx_z_) * 8)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 6)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 1)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 15)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 2)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 582)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 3)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 591)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 4)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 1158)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 5)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 1167)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 6)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 1734)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 7)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 1743)];
          asm ("bar.sync 2, 32;");
          conv2d_nchw_local[0] = (conv2d_nchw_local[0] + (pad_temp_shared[0] * kernel_shared[(((int)threadIdx_z_) * 4)]));
          conv2d_nchw_local[10] = (conv2d_nchw_local[10] + (pad_temp_shared[0] * kernel_shared[((((int)threadIdx_z_) * 4) + 64)]));
          conv2d_nchw_local[2] = (conv2d_nchw_local[2] + (pad_temp_shared[2] * kernel_shared[(((int)threadIdx_z_) * 4)]));
          ...
          asm ("bar.sync 2, 32;");
          if (((int)threadIdx_z_) < 9) {
              pad_temp_shared[(((int)threadIdx_z_) * 2)] = conv2d_0_data_[((((((((((int)blockIdx_z_) / 3) * 802816) + (rc_outer * 25088)) + (((((int)threadIdx_z_) * 2) / 9) * 12544)) + (((int)blockIdx_y_) * 1120)) + (((((int)threadIdx_z_) * 2) % 9) * 112)) + (((int)blockIdx_x_) * 2)) + 225)];
          }
          if (((int)threadIdx_z_) < 9) {
              pad_temp_shared[((((int)threadIdx_z_) * 2) + 1)] = conv2d_0_data_[((((((((((int)blockIdx_z_) / 3) * 802816) + (rc_outer * 25088)) + ((((((int)threadIdx_z_) * 2) + 1) / 9) * 12544)) + (((int)blockIdx_y_) * 1120)) + ((((((int)threadIdx_z_) * 2) + 1) % 9) * 112)) + (((int)blockIdx_x_) * 2)) + 225)];
          }
          kernel_shared[(((int)threadIdx_z_) * 8)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 7)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 1)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 16)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 2)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 583)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 3)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 592)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 4)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 1159)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 5)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 1168)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 6)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 1735)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 7)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 1744)];
          asm ("bar.sync 2, 32;");
          conv2d_nchw_local[0] = (conv2d_nchw_local[0] + (pad_temp_shared[0] * kernel_shared[(((int)threadIdx_z_) * 4)]));
          conv2d_nchw_local[10] = (conv2d_nchw_local[10] + (pad_temp_shared[0] * kernel_shared[((((int)threadIdx_z_) * 4) + 64)]));
          conv2d_nchw_local[2] = (conv2d_nchw_local[2] + (pad_temp_shared[2] * kernel_shared[(((int)threadIdx_z_) * 4)]));
          ...
          asm ("bar.sync 2, 32;");
          if (((int)threadIdx_z_) < 9) {
              pad_temp_shared[(((int)threadIdx_z_) * 2)] = conv2d_0_data_[((((((((((int)blockIdx_z_) / 3) * 802816) + (rc_outer * 25088)) + (((((int)threadIdx_z_) * 2) / 9) * 12544)) + (((int)blockIdx_y_) * 1120)) + (((((int)threadIdx_z_) * 2) % 9) * 112)) + (((int)blockIdx_x_) * 2)) + 226)];
          }
          if (((int)threadIdx_z_) < 9) {
              pad_temp_shared[((((int)threadIdx_z_) * 2) + 1)] = conv2d_0_data_[((((((((((int)blockIdx_z_) / 3) * 802816) + (rc_outer * 25088)) + ((((((int)threadIdx_z_) * 2) + 1) / 9) * 12544)) + (((int)blockIdx_y_) * 1120)) + ((((((int)threadIdx_z_) * 2) + 1) % 9) * 112)) + (((int)blockIdx_x_) * 2)) + 226)];
          }
          kernel_shared[(((int)threadIdx_z_) * 8)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 8)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 1)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 17)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 2)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 584)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 3)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 593)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 4)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 1160)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 5)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 1169)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 6)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 1736)];
          kernel_shared[((((int)threadIdx_z_) * 8) + 7)] = conv2d_0_kernel_[(((((((int)blockIdx_z_) % 3) * 36864) + (((int)threadIdx_z_) * 2304)) + (rc_outer * 18)) + 1745)];
          asm ("bar.sync 2, 32;");
          conv2d_nchw_local[0] = (conv2d_nchw_local[0] + (pad_temp_shared[0] * kernel_shared[(((int)threadIdx_z_) * 4)]));
          conv2d_nchw_local[10] = (conv2d_nchw_local[10] + (pad_temp_shared[0] * kernel_shared[((((int)threadIdx_z_) * 4) + 64)]));
          conv2d_nchw_local[2] = (conv2d_nchw_local[2] + (pad_temp_shared[2] * kernel_shared[(((int)threadIdx_z_) * 4)]));
